...
<p style="margin: 0 0 16px;">Your order has been confirmed. Thank you for paying with PascalCoin!</p>
        ...
        <tbody>
            ...
            <tr>
                <td class="td" style="text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap: break-word; color: #636363; border: 1px solid #e5e5e5; padding: 12px;">
                    TOTAL DUE: <br/>
                    <strong>
                        <?php echo $details['amount_total_formatted']; ?> PASC
                    </strong>
                </td>
            </tr>
            <tr>
                <td class="td" style="text-align: left; vertical-align: middle; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; word-wrap: break-word; color: #636363; border: 1px solid #e5e5e5; padding: 12px;">
                    EXCHANGE RATE: <br/>
                    <strong>
                        1 PASC = <?php echo $details['rate_formatted'] . ' ' . $details['currency']; ?>
                    </strong>
                </td>
            </tr>
        </tbody>
