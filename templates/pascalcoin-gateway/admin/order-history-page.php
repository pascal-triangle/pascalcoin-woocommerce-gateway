<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    <tr>
        <td>Exchange rate</td>
        <td>1 PASC = <?php echo $details['rate_formatted'].' '.$details['currency']; ?></td>
    </tr>
    <tr>
        <td>Total amount</td>
        <td><?php echo $details['amount_total_formatted']; ?> PASC</td>
    </tr>
    <tr>
        <td>Total paid</td>
        <td><?php echo $details['amount_paid_formatted']; ?> PASC</td>
    </tr>
    <tr>
        <td>Total due</td>
        <td><?php echo $details['amount_due_formatted']; ?> PASC</td>
    </tr>
    <tr>
        <td>Order age</td>
        <td><?php echo Pascalcoin_Gateway::format_seconds_to_time($details['order_age']) ?> ago</td>
    </tr>
    <tr>
...
<table class="striped" style="width:100%" cellspacing="0" cellpadding="5">
    ...
    <tr>
        <td>
            <a href="<?php echo PASCALCOIN_GATEWAY_EXPLORER_URL.'/findoperation.php?ophash='.$tx['txid']; ?>" target="_blank"><?php echo $tx['txid']; ?></a>
        </td>
        <td><?php echo $tx['height']; ?></td>
        <td><?php echo sprintf(PASCALCOIN_GATEWAY_ATOMIC_UNITS_SPRINTF, $tx['amount'] / PASCALCOIN_GATEWAY_ATOMIC_UNITS_POW); ?> PASC</td>
    </tr>
    <?php endforeach; ?>
</table>
<?php endif; ?>
